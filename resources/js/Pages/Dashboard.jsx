...
export default function Dashboard() {
    ...
    return (
        <>
            {usePage().props.auth.user.role === 'admin' ?<div className="container-fluid py-4">
                <div className="row">
                                ...
                                <div className="row">
                                    <div className="col-8">
                                        <div className="numbers">
                                            <p className="text-sm mb-0 text-uppercase font-weight-bold">Today's
                                                Money</p>
                        ...
                        <div className="card">
                            <div className="card-body p-3">
                                <div className="row">
                                    ...
                                    <div className="col-4 text-end">
                                        <div
                                            className="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle">
                        ...
                        <div className="card">
                            <div className="card-body p-3">
                                <div className="row">
                                    ...
                                    <div className="col-4 text-end">
                                        <div
                                            className="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle">
                        ...
                        <div className="card card-carousel overflow-hidden h-100 p-0">
                            <div id="carouselExampleCaptions" className="carousel slide h-100" data-bs-ride="carousel">
                                <div className="carousel-inner border-radius-lg h-100">
                                    ...
                                    <div className="carousel-item h-100" style={{
            ...
            </div> : <div className="container-fluid py-4">
